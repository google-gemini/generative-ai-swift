...
public struct GenerateMessageRequest: Codable {
  /// Optional. If specified, nucleus sampling will be used as the decoding strategy. Nucleus sampling considers the smallest set of tokens whose probability sum is at least `top_p`.
  public var topP: Float?
  /// Optional. The number of generated response messages to return. This value must be between `[1, 10]`, inclusive. If unset, this will default to `1`.
  ...
  /// Optional. If specified, top-k sampling will be used as the decoding strategy. Top-k sampling considers the set of `top_k` most probable tokens.
  public var topK: Int32?

  public init(topP: Float? = nil, candidateCount: Int32? = nil, prompt: MessagePrompt? = nil, temperature: Float? = nil, topK: Int32? = nil) {
    self.topP = topP
